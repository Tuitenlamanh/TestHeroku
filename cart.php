  ...
  <form method="post">
    <table border="1">
      ...
      if ($check_user == 0){
        ...
        $sql = "select * from song, cart where Song.SongID = cart.SongID AND UserName='$UserName'";
        ...
        while($row_cart =  mysqli_fetch_array($result)){
          ...
          $SongID =$row_cart['SongID'];
          $total = $total + $Price;
          echo "
          <tr>
          <td ><a href='detailsong.php?SongID=$SongID' >$SongName</a></td>
          <td class='col-md-2 col-sm-3 col-4'><img src='$SongImage' width='50' height='50' ></td>
